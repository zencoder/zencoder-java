...
/**
 * @see https://app.zencoder.com/docs/api/encoding/notifications/notification-event
 */
public enum NotificationEvent {

    FIRST_SEGMENT_UPLOADED("first_segment_uploaded"),
    SEAMLESS_PLAYBACK("seamless_playback");
