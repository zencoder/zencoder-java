...
/**
 * @see https://app.zencoder.com/docs/api/encoding/job/input-aspera-transfer-policy
 */
public enum AsperaTransferPolicy {

    FAIR("fair"),
    LOW("low");
    // NOTE: HIGH is not supported.

    private String name;

    AsperaTransferPolicy(String name) {
        this.name = name;
    }
